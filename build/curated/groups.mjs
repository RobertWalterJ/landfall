...
export const GROUPS = [
  ...
  },
  {
    ...
    members: ['c:VG', 'c:VI', 'c:AI', 'c:MF', 'c:SX', 'c:BL', 'i:saba', 'i:sint-eustatius',
      'i:st-kitts', 'i:nevis', 'c:AG', 'c:MS', 'i:basse-terre-island', 'i:grande-terre',
      'i:marie-galante', 'i:la-desirade'],
    contested: ['c:DM'],
  ...
  },
  {
    ...
    members: ['c:MQ', 'c:LC', 'i:st-vincent-island', 'c:GD'],
  ...
  },
  {
    ...
    members: ['i:bequia', 'i:mustique', 'i:canouan', 'i:union-island', 'i:carriacou'],
    note: 'Carriacou and Petite Martinique belong to Grenada; everything north of them to Saint Vincent.',
  },
  {
